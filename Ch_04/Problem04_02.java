...
/**
 * 4.2 Geometry: great circle distance) The great circle distance is the distance between two points on the surface of a sphere. Let (x1, y1) and (x2, y2) be the
 * geographical latitude and longitude of two points. The great circle distance between the two points can be computed using the following formula:
